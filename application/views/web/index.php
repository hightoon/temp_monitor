...
<header>
     <div class="container">
          <div class="navbar">
               <div class="navbar-inner"> <a class="brand" href="<?php $tmp=base_url(); echo $tmp.'index.php/index/index'?>"> <img src="<?php $tmp=base_url(); echo $tmp.'web/images/logo.png'?>" width="90" height="90" alt="optional logo" /> <span class="logo_title"><strong>工业互联网</strong></span> <span class="logo_subtitle">我们专注于工业互联网，追求卓越</span> </a> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span class="nb_left pull-left"> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span></span> <span class="nb_right pull-right">menu</span> </a>
...
<section id="slider_wrapper" class="container">
     <div id="main_flexslider" class="flexslider">
          <ul class="slides">
               <li class="item" style="background-image: url(<?php $tmp=base_url(); echo $tmp.'web/images/sj1.jpg'?>)">
                    <div class="container">
                         <div class="carousel-caption">
                               <h1>联通万物<br />
                                   助力企业发展，走向更大舞台!</h1>
                              <!--p class="lead"><strong>工业互联网</strong> 我们专注于 <a><strong>工业互联网</strong></a> ，我们致力于帮助企业进入工业互联网的时代。在工业互联网的平台上，让您的企业插上腾飞的翅膀，获取更大的发展！</p-->
                         </div>
                    </div>
               </li>
               <li class="item" style="background-image: url(<?php $tmp=base_url(); echo $tmp.'web/images/sj2.jpg'?>)">
                    <div class="container">
                         <div class="carousel-caption">
                              <h1>多种终端<br />
                                   信息交互，随时随地</h1>
                              <!--p class="lead inverse">支持多种平台，在任何网络覆盖的地方，您都能通过任何方式与您的设备交互</p-->
                         </div>
                    </div>
               </li>
               <li class="item" style="background-image: url(<?php $tmp=base_url(); echo $tmp.'web/images/sj3.jpg'?>)">
                    <div class="container">
                         <div class="carousel-caption">
                              <h1 class="inverse">智慧信息<br />
                                   中国智造，慧及全球</h1>
                              <!--p class="lead">通过对海量数据的<a><strong>云端分析</strong></a>，您将获得更加全面的信息，
                                   准确把握您设备的最新状况，<br/>让您<a><strong>运筹帷幄，决胜千里</strong></a></p-->
                         </div>
                    </div>
               </li>
          </ul>
...
<div id="main">
     <div class="container">
          <section id="features_teasers_wrapper">
               <div class="row">
                    <div class="span4 feature_teaser"> <img style="height:96px" alt="responsive" src="<?php $tmp=base_url(); echo $tmp.'web/images/network.png'?>" />
                         <h4>联通万物</h4>
                         <p>我们构建稳固的<strong>工业互联网平台</strong>，面向工业设备，比如空压机、钻车、数控机床、净化设备等等。联通所有设备，助力您的企业迈向工业互联时代！</p>
                    </div>
                    <div class="span4 feature_teaser"> <img alt="responsive" src="<?php $tmp=base_url(); echo $tmp.'web/images/responsive.png'?>"/>
                         <h4>多种终端</h4>
                         <p>全面支持个人电脑、手机、平板等<strong>多种终端</strong>，我们提供web以及手机app的访问方式，在任何地方，通过多种方式与设备交互。随时掌控您的设备！</p>
                    </div>
                    <div class="span4 feature_teaser"> <img style="height:96px" alt="responsive" src="<?php $tmp=base_url(); echo $tmp.'web/images/cloud.png'?>" />
                         <h4>智慧信息</h4>
                         <p>通过对海量数据的<strong>云端分析</strong>，您将获得更加全面的信息，为企业的发展做出科学、合理的决策，有效提升企业核心竞争力，让您运筹帷幄，决胜千里！</p>
                    </div>
               </div>
          </section>
		  ...
		  <p>解决方案</p>
               ...
               <div class="portfolio_strict row">
                    <div class="portfolio_item span3">
                         <div class="portfolio_photo" style="background-image:url(<?php $tmp=base_url(); echo $tmp.'web/images/portfolio/future.jpg'?>)"> <a href="portfolio_item.html"> <i class="icon-2x icon-external-link"></i>
                              <p>在工业互联网的平台上，帮助您的企业插上腾飞的翅膀！...</p>
                              </a> </div>
                         <div class="portfolio_description">
                              <h3><a href="portfolio_item.html">工业</a></h3>
                              <p>工业领域设备联网</p>
                         </div>
                    </div>
                    <div class="portfolio_item span3">
                         ...
                         <div class="portfolio_description">
                              <h3><a href="portfolio_item.html">商用</a></h3>
                              <p>商业服务联网</p>
                         </div>
                    </div>
                    <div class="portfolio_item span3">
                         ...
                         <div class="portfolio_description">
                              <h3><a href="portfolio_item.html">家用</a></h3>
                              <p>家庭智能化方案</p>
                         </div>
                    </div>
                    <div class="portfolio_item span3">
                         ...
                         <div class="portfolio_description">
                              <h3><a href="portfolio_item.html">个人</a></h3>
                              <p>便捷的个人网络</p>
                         </div>
                    </div>
               </div>
     ...
     <footer>
               ...
               <div class="container">
                    <div class="row">
                         <div class="span4 footer_teaser">
                              <h3>关于我们</h3>
                              <p>我们专注于工业互联网领域，我们致力于帮助企业进入工业互联网的时代。在工业互联网的平台上，让您的企业插上腾飞的翅膀，获取更大的发展！</p>
                              <p><i class="icon-map-marker"></i> 浙江省杭州市西湖区</p>
                              <p><i class="icon-phone"></i> (+0571) 8795-1348</p>
                              <p><i class="icon-print"></i> (+0571) 8795-1348</p>
                              <p><i class="icon-envelope"></i> robosnet@126.com</p>
                         </div>
                         <div class="span4 footer_teaser">
                              <h3>最新新闻</h3>
                              <ul class="media-list">
                                   <li class="media"> <a href="#" class="media-photo" style="background-image:url(<?php $tmp=base_url(); echo $tmp.'web/images/portfolio/t5.jpg'?>)"></a> <a href="#" class="media-date">19<span>FEB</span></a>
                                        <h5 class="media-heading"><!--a href="#"-->工业4.0,引领新一代工业革命.<!--/a--></h5>
                                        <p>德国提出的工业4.0标准...</p>
                                   </li>
                                   <li class="media"> <a href="#" class="media-photo" style="background-image:url(<?php $tmp=base_url(); echo $tmp.'web/images/portfolio/t4.jpg'?>)"></a> <a href="#" class="media-date">18<span>FEB</span></a>
                                        <h5 class="media-heading"><!--a href="#"-->中国经济稳中回暖.<!--/a--></h5>
                                        <p>在经历了全球金融危机后...</p>
                                   </li>
                              </ul>
                         </div>
                         <div class="span4 footer_teaser" id="latest-flickr-images">
                              <h3>反馈</h3>
                              <p>如有问题请联系我们 &copy; by <!--a href="#" target="_blank"-->robosnet<!--/a-->.</p>
                              <ul>
                              </ul>
                         </div>
                    </div>
          ...
          <section id="copyright">
               <div class="container">
                    <div class="row">
                         <div class="span6">版权所有 &copy; robosnet.<a target="_blank" href=""></a></div>
                    </div>
               </div>
          </section>
     </footer>
