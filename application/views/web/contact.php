          ...
          <section id="contact">
               ...
               <div class="row">
                    <div class="span4 office_address">
                         <address>
                         <strong>浙江省杭州市西湖区.</strong><br />
                         浙大路38号<br />
                         邮编：310027<br />
                         <abbr title="Phone">电话:</abbr> (0571) 8795-1348
                         </address>
                         <address>
                         <strong>Email</strong><br />
                         <a href="mailto:#">robosnet@126.com</a>
                         </address>
                    </div>
                    <div class="span8 contact_form">
                         <form />
                              <div class="row">
                                   ...
                                   <div class="span8"> <a class="btn btn-large btn-success" href="<?php $tmp=base_url(); echo $tmp.'index.php/index/index'?>"><span>提交信息</span></a> </div>
                              </div>
                         </form>
                    </div>
               </div>
