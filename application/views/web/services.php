               ...
               <div class="navbar-inner"> <a class="brand" href="<?php $tmp=base_url(); echo $tmp.'index.php/index/index'?>"> <img src="<?php $tmp=base_url(); echo $tmp.'web/images/logo.png'?>" width="90" height="90" alt="optional logo" /> <span class="logo_title"><strong>工业互联网</strong></span> <span class="logo_subtitle">我们专注于工业互联网，追求卓越</span> </a> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span class="nb_left pull-left"> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span></span> <span class="nb_right pull-right">menu</span> </a>
                    <div class="nav-collapse collapse">
                         <ul class="nav pull-right">
                              <li><a href="<?php $tmp=base_url(); echo $tmp.'index.php/index/index'?>">首页</a></li>
...
<div id="main">
     <div class="container">
          <section id="services">
               <div class="hgroup">
                    <h1>服务</h1>
                    <!--h2>我们专注于工业互联网，追求卓越</h2-->
                    <ul class="breadcrumb pull-right">
                         <li><a href="http://www.robosnet.com">Home</a> <span class="divider">/</span></li>
                         <li class="active">Services</li>
                    </ul>
               </div>
               <div class="row-fluid service_teaser">
                    <div class="span4 teaser_photo"> <img src="<?php $tmp=base_url(); echo $tmp.'web/images/future.jpg'?>" alt="a" class="img-rounded" /> </div>
                    <div class="span8">
                         <h3>稳健，高效，极致</h3>
                         <p>我们将始终如一的追求极致，为用户提供最稳健的产品。服务是我们的命脉，我们将为工业新时代的到来提供最优质的服务，为您创造更高的价值。高效的团队是我们最坚实的后盾，我们团结一心，奋力拼搏！</p>
                         <p>&nbsp;</p>
                         <hr />
                         <div class="row-fluid">
                              <div class="span6 service">
                                   ...
                                   <div class="desc span8">
                                        <h4>全设备的连接</h4>
                                        <p>我们致力于提供工业互联网的服务，面向工业设备的全连接。在我们的平台上，您将更加有效的管理您的设备，获取更加丰富的信息，获得更大的收益！</p>
                                   </div>
                              </div>
                              <div class="span6 service">
                                   ...
                                   <div class="desc span8">
                                        <h4>优质的服务</h4>
                                        <p>服务是我们平台的目的，我们坚持追求极致的理念，将最优质的工业互联服务提供给您。</p>
                                   </div>
                              </div>
                         </div>
                    </div>
               ...
               <div class="span3 service text-center">
                    ...
                    <div class="desc">
                         <h4>云端数据处理</h4>
                         <p>我们充分利用云端强大的计算能力，充分发掘数据背后的价值，将更多的信息完整的呈现给您，让您的企业踏上云计算的快车！ </p>
                    </div>
               </div>
               <div class="span3 service text-center">
                    ...
                    <div class="desc">
                         <h4>高效数据分析</h4>
                         <p>海量数据是云计算的基础，高效分析是发掘价值的必要手段。通过对数据的分析，帮助您从纷繁复杂中抽丝剥茧，把握未来！ </p>
                    </div>
               </div>
               <div class="span3 service text-center">
                    ...
                    <div class="desc">
                         <h4>开放的平台</h4>
                         <p>面向工业发展的新时代，我们永远保持开放的心态，提供开放的平台，热忱欢迎您的参与，一同加入新工业革命的浪潮中！</p>
                    </div>
               </div>
               <div class="span3 service text-center">
                    ...
                    <div class="desc">
                         <h4>最极致的产品</h4>
                         <p>我们将为您提供最极致的产品，为您在新工业革命的浪潮中提供优质的服务，让您的企业踏上浪潮之巅，驶向更加广阔的海洋！</p>
                    </div>
               </div>
          </div>
     </div>
