...
<div id="main">
     <div class="container">
          <div class="hgroup">
               <h1>案例展示</h1>
               <!--h2>我们专注于工业互联网领域，我们致力于帮助企业进入工业互联网的时代。在工业互联网的平台上，让您的企业插上腾飞的翅膀，获取更大的发展！</h2-->
          ...
          <div id="portfolio_container" class="portfolio_strict row">
               <div class="portfolio_item cat_travel span4">
                    <div class="portfolio_photo" style="background-image:url(<?php $tmp=base_url(); echo $tmp.'web/images/car.png'?>)"> <a href="#"> <!--i class="icon-2x icon-external-link"></i-->
                         <p>工程车辆管理、定位、远程控制</p>
                         </a> </div>
               ...
               <div class="portfolio_item cat_people span4">
                    <div class="portfolio_photo" style="background-image:url(<?php $tmp=base_url(); echo $tmp.'web/images/gas.png'?>)"> <a href="#"> <!--i class="icon-2x icon-external-link"></i-->
                         <p>空气压缩机管理、定位、能耗分析、远程控制</p>
                         </a> </div>
                    <div class="portfolio_description">
                         <h3><a href="#">案例二</a></h3>
                         <p>空气压缩机联网</p>
               ...
               <div class="portfolio_item cat_artists span4">
                    <div class="portfolio_photo" style="background-image:url(<?php $tmp=base_url(); echo $tmp.'web/images/clean.png'?>)"> <a href="#"> <!--i class="icon-2x icon-external-link"></i-->
                         <p>空气净化器管理、定位、远程控制</p>
                         </a> </div>
                    <div class="portfolio_description">
                         <h3><a href="#">案例三</a></h3>
               ...
               <div class="portfolio_item cat_people span4">
                    <div class="portfolio_photo" style="background-image:url(<?php $tmp=base_url(); echo $tmp.'web/images/future.jpg'?>)"> <a href="#"> <!--i class="icon-2x icon-external-link"></i-->
                         <p>我们专注于工业互联网领域，我们致力于帮助企业进入工业互联网的时代...</p>
                         </a> </div>
                    <div class="portfolio_description">
                         <h3><a href="#">案例四</a></h3>
                         <p>案例四</p>
