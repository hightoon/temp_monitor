<div id="wrapper">
        ...
        <div id="page-wrapper">
			...
			<div class="row">
				...
				<?php if(isset($meters['deliveryairtemp'])):?>
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" id="deliveryairtemp_meter">
				<?php else:?>
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" id="deliveryairtemp_meter" style="display:none">
				<?php endif?>
					<div class="panel panel-green">
						<div class="panel-heading">
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-right" style="height:110px">
									<div class="pull-left">
										<div class="btn-group">
											<button type="button" class="btn btn-green btn-xs meter-close" id="deliveryairtemp_meter_close">
												<i class="fa fa-close"></i>
											</button>
											<button type="button" class="btn btn-green btn-xs flot-close" id="deliveryairtemp_flot_close">
												<i class="fa fa-chevron-left"></i>
											</button>
											<button type="button" class="btn btn-green btn-xs">
												<i class="fa fa-cog"></i>
									...
									<div>传输空气温度</div>
									<div><span class="huge" id="deliveryairtemp"> - </span>mCEL</div>
									<div>采集时间</div>
									<div class="update_time"> - </div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
									<div id="deliveryairtemp_flot" style="height:90px;margin-bottom:10px" ></div>
									<div class="progress progress-striped active" style="margin-bottom:0">
									   <div id="deliveryairtemp_img" class="progress-bar " role="progressbar" 
										  aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
									   </div>
									</div>
								</div>
				...
				<?php if(isset($meters['deliverypress'])):?>
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" id="deliverypress_meter">
				<?php else:?>
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" id="deliverypress_meter" style="display:none">
				<?php endif?>
					<div class="panel panel-green">
						<div class="panel-heading">
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-right" style="height:110px">
									<div class="pull-left">
										<div class="btn-group">
											<button type="button" class="btn btn-green btn-xs meter-close" id="deliverypress_meter_close">
												<i class="fa fa-close"></i>
											</button>
											<button type="button" class="btn btn-green btn-xs flot-close" id="deliverypress_flot_close">
												<i class="fa fa-chevron-left"></i>
											</button>
											<button type="button" class="btn btn-green btn-xs">
												<i class="fa fa-cog"></i>
									...
									<div>传输压力</div>
									<div><span class="huge" id="deliverypress"> - </span>mBAR</div>
									<div>采集时间</div>
									<div class="update_time"> - </div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
									<div id="deliverypress_flot" style="height:90px;margin-bottom:10px" ></div>
									<div class="progress progress-striped active" style="margin-bottom:0">
									   <div id="deliverypress_img" class="progress-bar " role="progressbar" 
										  aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
									   </div>
									</div>
								</div>
				...
				<?php if(isset($meters['internalpress'])):?>
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" id="internalpress_meter">
				<?php else:?>
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" id="internalpress_meter" style="display:none">
				<?php endif?>
					<div class="panel panel-green">
						<div class="panel-heading">
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-right" style="height:110px">
									<div class="pull-left">
										<div class="btn-group">
											<button type="button" class="btn btn-green btn-xs meter-close" id="internalpress_meter_close">
												<i class="fa fa-close"></i>
											</button>
											<button type="button" class="btn btn-green btn-xs flot-close" id="internalpress_flot_close">
												<i class="fa fa-chevron-left"></i>
											</button>
											<button type="button" class="btn btn-green btn-xs">
												<i class="fa fa-cog"></i>
									...
									<div>内部压力</div>
									<div><span class="huge" id="internalpress"> - </span>mBAR</div>
									<div>采集时间</div>
									<div class="update_time"> - </div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
									<div id="internalpress_flot" style="height:90px;margin-bottom:10px" ></div>
									<div class="progress progress-striped active" style="margin-bottom:0">
									   <div id="internalpress_img" class="progress-bar " role="progressbar" 
										  aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
									   </div>
									</div>
								</div>
				...
				<?php if(isset($meters['differpress'])):?>
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" id="differpress_meter">
				<?php else:?>
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" id="differpress_meter" style="display:none">
				<?php endif?>
					<div class="panel panel-green">
						<div class="panel-heading">
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-right" style="height:110px">
									<div class="pull-left">
										<div class="btn-group">
											<button type="button" class="btn btn-green btn-xs meter-close" id="differpress_meter_close">
												<i class="fa fa-close"></i>
											</button>
											<button type="button" class="btn btn-green btn-xs flot-close" id="differpress_flot_close">
												<i class="fa fa-chevron-left"></i>
											</button>
											<button type="button" class="btn btn-green btn-xs">
												<i class="fa fa-cog"></i>
									...
									<div>压力差</div>
									<div><span class="huge" id="differpress"> - </span>mBAR</div>
									<div>采集时间</div>
									<div class="update_time"> - </div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
									<div id="differpress_flot" style="height:90px;margin-bottom:10px" ></div>
									<div class="progress progress-striped active" style="margin-bottom:0">
									   <div id="differpress_img" class="progress-bar " role="progressbar" 
										  aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
									   </div>
									</div>
								</div>
				...
				<?php if(isset($meters['oilairsepfilterdp'])):?>
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" id="oilairsepfilterdp_meter">
				<?php else:?>
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" id="oilairsepfilterdp_meter" style="display:none">
				<?php endif?>
					<div class="panel panel-green">
						<div class="panel-heading">
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-right" style="height:110px">
									<div class="pull-left">
										<div class="btn-group">
											<button type="button" class="btn btn-green btn-xs meter-close" id="oilairsepfilterdp_meter_close">
												<i class="fa fa-close"></i>
											</button>
											<button type="button" class="btn btn-green btn-xs flot-close" id="oilairsepfilterdp_flot_close">
												<i class="fa fa-chevron-left"></i>
											</button>
											<button type="button" class="btn btn-green btn-xs">
												<i class="fa fa-cog"></i>
									...
									<div>油气分离压力</div>
									<div><span class="huge" id="oilairsepfilterdp"> - </span>mBAR</div>
									<div>采集时间</div>
									<div class="update_time"> - </div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
									<div id="oilairsepfilterdp_flot" style="height:90px;margin-bottom:10px" ></div>
									<div class="progress progress-striped active" style="margin-bottom:0">
									   <div id="oilairsepfilterdp_img" class="progress-bar " role="progressbar" 
										  aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
									   </div>
									</div>
								</div>
				...
				<?php if(isset($meters['motorcur'])):?>
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" id="motorcur_meter">
				<?php else:?>
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" id="motorcur_meter" style="display:none">
				<?php endif?>
					<div class="panel panel-green">
						<div class="panel-heading">
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-right" style="height:110px">
									<div class="pull-left">
										<div class="btn-group">
											<button type="button" class="btn btn-green btn-xs meter-close" id="motorcur_meter_close">
												<i class="fa fa-close"></i>
											</button>
											<button type="button" class="btn btn-green btn-xs flot-close" id="motorcur_flot_close">
												<i class="fa fa-chevron-left"></i>
											</button>
											<button type="button" class="btn btn-green btn-xs">
												<i class="fa fa-cog"></i>
									...
									<div>电机电流</div>
									<div><span class="huge" id="motorcur"> - </span>mAMP×100</div>
									<div>采集时间</div>
									<div class="update_time"> - </div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
									<div id="motorcur_flot" style="height:90px;margin-bottom:10px" ></div>
									<div class="progress progress-striped active" style="margin-bottom:0">
									   <div id="motorcur_img" class="progress-bar " role="progressbar" 
										  aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
									   </div>
									</div>
								</div>
				...
				<?php if(isset($meters['fanmotorcur'])):?>
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" id="fanmotorcur_meter">
				<?php else:?>
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" id="fanmotorcur_meter" style="display:none">
				<?php endif?>
					<div class="panel panel-green">
						<div class="panel-heading">
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-right" style="height:110px">
									<div class="pull-left">
										<div class="btn-group">
											<button type="button" class="btn btn-green btn-xs meter-close" id="fanmotorcur_meter_close">
												<i class="fa fa-close"></i>
											</button>
											<button type="button" class="btn btn-green btn-xs flot-close" id="fanmotorcur_flot_close">
												<i class="fa fa-chevron-left"></i>
											</button>
											<button type="button" class="btn btn-green btn-xs">
												<i class="fa fa-cog"></i>
									...
									<div>电机风扇电流</div>
									<div><span class="huge" id="fanmotorcur"> - </span>mAMP×10</div>
									<div>采集时间</div>
									<div class="update_time"> - </div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
									<div id="fanmotorcur_flot" style="height:90px;margin-bottom:10px" ></div>
									<div class="progress progress-striped active" style="margin-bottom:0">
									   <div id="fanmotorcur_img" class="progress-bar " role="progressbar" 
										  aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
									   </div>
									</div>
								</div>
				...
				<?php if(isset($meters['loadpress'])):?>
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" id="loadpress_meter">
				<?php else:?>
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" id="loadpress_meter" style="display:none">
				<?php endif?>
					<div class="panel panel-green">
						<div class="panel-heading">
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-right" style="height:110px">
									<div class="pull-left">
										<div class="btn-group">
											<button type="button" class="btn btn-green btn-xs meter-close" id="loadpress_meter_close">
												<i class="fa fa-close"></i>
											</button>
											<button type="button" class="btn btn-green btn-xs flot-close" id="loadpress_flot_close">
												<i class="fa fa-chevron-left"></i>
											</button>
											<button type="button" class="btn btn-green btn-xs">
												<i class="fa fa-cog"></i>
									...
									<div>加载压力</div>
									<div><span class="huge" id="loadpress"> - </span>mBAR</div>
									<div>采集时间</div>
									<div class="update_time"> - </div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
									<div id="loadpress_flot" style="height:90px;margin-bottom:10px" ></div>
									<div class="progress progress-striped active" style="margin-bottom:0">
									   <div id="loadpress_img" class="progress-bar " role="progressbar" 
										  aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
									   </div>
									</div>
								</div>
				...
				<?php if(isset($meters['unloadpress'])):?>
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" id="unloadpress_meter">
				<?php else:?>
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" id="unloadpress_meter" style="display:none">
				<?php endif?>
					<div class="panel panel-green">
						<div class="panel-heading">
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-right" style="height:110px">
									<div class="pull-left">
										<div class="btn-group">
											<button type="button" class="btn btn-green btn-xs meter-close" id="unloadpress_meter_close">
												<i class="fa fa-close"></i>
											</button>
											<button type="button" class="btn btn-green btn-xs flot-close" id="unloadpress_flot_close">
												<i class="fa fa-chevron-left"></i>
											</button>
											<button type="button" class="btn btn-green btn-xs">
												<i class="fa fa-cog"></i>
									...
									<div>卸载压力</div>
									<div><span class="huge" id="unloadpress"> - </span>mBAR</div>
									<div>采集时间</div>
									<div class="update_time"> - </div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
									<div id="unloadpress_flot" style="height:90px;margin-bottom:10px" ></div>
									<div class="progress progress-striped active" style="margin-bottom:0">
									   <div id="unloadpress_img" class="progress-bar " role="progressbar" 
										  aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
									   </div>
									</div>
								</div>
				...
				<?php if(isset($meters['coolingdp'])):?>
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" id="coolingdp_meter">
				<?php else:?>
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" id="coolingdp_meter" style="display:none">
				<?php endif?>
					<div class="panel panel-green">
						<div class="panel-heading">
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-right" style="height:110px">
									<div class="pull-left">
										<div class="btn-group">
											<button type="button" class="btn btn-green btn-xs meter-close" id="coolingdp_meter_close">
												<i class="fa fa-close"></i>
											</button>
											<button type="button" class="btn btn-green btn-xs flot-close" id="coolingdp_flot_close">
												<i class="fa fa-chevron-left"></i>
											</button>
											<button type="button" class="btn btn-green btn-xs">
												<i class="fa fa-cog"></i>
									...
									<div>冷却压力</div>
									<div><span class="huge" id="coolingdp"> - </span>mBAR</div>
									<div>采集时间</div>
									<div class="update_time"> - </div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
									<div id="coolingdp_flot" style="height:90px;margin-bottom:10px" ></div>
									<div class="progress progress-striped active" style="margin-bottom:0">
									   <div id="coolingdp_img" class="progress-bar " role="progressbar" 
										  aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
									   </div>
									</div>
								</div>
						...
						<a href="<?php $tmp=base_url();echo $tmp."index.php/admin/".$onlineEqp_item['href']?>">
							...
							style="width:60px;height:60px;border-radius:30px;padding:0;margin:10px;border-color:#fff;"><?php echo $onlineEqp_item['num']?></button>
								...
								<div class="chat-body clearfix" style="background-color:#5cc;padding:5px 20px">
									...
									<p>控制器型号：<?php echo $onlineEqp_item['cv_controller']?></p>
								</div>
							</li>
						<?php $flag=1;?>
						<?php else:?>
		...
		<div class="modal-dialog" style="width:400px">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<br>
					<div class="row text-center">
						<button type="submit" class="btn btn-success btn-sm meter active" style="width:100px">传输空气温度（√）</button>
						<button type="submit" class="btn btn-success btn-sm meter active" style="width:100px">传输压力（√）</button>
						<button type="submit" class="btn btn-success btn-sm meter active" style="width:100px">内部压力（√）</button>
					</div>
					<br>
					<div class="row text-center">
						<button type="submit" class="btn btn-success btn-sm meter active" style="width:100px">压力差（√）</button>
						<button type="submit" class="btn btn-success btn-sm meter active" style="width:100px">油气分离压力（√）</button>
						<button type="submit" class="btn btn-success btn-sm meter active" style="width:100px">电机电流（√）</button>
					</div>
					<br>
					<div class="row text-center">
						<button type="submit" class="btn btn-success btn-sm meter active" style="width:100px">电机风扇电流（√）</button>
						<button type="submit" class="btn btn-success btn-sm meter active" style="width:100px">加载压力（√）</button>
						<button type="submit" class="btn btn-success btn-sm meter active" style="width:100px">卸载压力（√）</button>
					</div>
					<br>
					<div class="row text-center">
					...
					<div class="row text-center">
						...
						<button type="submit" class="btn btn-success btn-sm meter active" style="width:100px">冷却压力（√）</button>
					</div>
				</div>
				<div class="modal-footer">
