...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_kl0">
	<div>
		<h4>空滤器保养信息<span id="kl_0"><?php 
			...
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Airfilter' && $allMaintain_item['time_left'] <= 0){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Airfilter' && $allMaintain_item['time_left'] <= 0):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_kl1">
	<div>
		<h4>空滤器保养信息<span id="kl_1"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Airfilter' && $allMaintain_item['time_left'] <= 24 && $allMaintain_item['time_left'] > 0){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Airfilter' && $allMaintain_item['time_left'] <= 24 && $allMaintain_item['time_left'] > 0):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_kl2">
	<div>
		<h4>空滤器保养信息<span id="kl_2"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Airfilter' && $allMaintain_item['time_left'] <= 168 && $allMaintain_item['time_left'] > 24){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Airfilter' && $allMaintain_item['time_left'] <= 168 && $allMaintain_item['time_left'] > 24):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_kl3">
	<div>
		<h4>空滤器保养信息<span id="kl_3"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Airfilter' && $allMaintain_item['time_left'] <= 720 && $allMaintain_item['time_left'] > 168){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Airfilter' && $allMaintain_item['time_left'] <= 720 && $allMaintain_item['time_left'] > 168):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_kl4">
	<div>
		<h4>空滤器保养信息<span id="kl_4"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Airfilter' && $allMaintain_item['time_left'] <= 1440 && $allMaintain_item['time_left'] > 720){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Airfilter' && $allMaintain_item['time_left'] <= 1440 && $allMaintain_item['time_left'] > 720):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_kl5">
	<div>
		<h4>空滤器保养信息<span id="kl_5"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Airfilter' && $allMaintain_item['time_left'] > 1440){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Airfilter' && $allMaintain_item['time_left'] > 1440):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_yl0">
	<div>
		<h4>油滤器保养信息<span id="yl_0"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Oilfilter' && $allMaintain_item['time_left'] <= 0){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Oilfilter' && $allMaintain_item['time_left'] <= 0):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_yl1">
	<div>
		<h4>油滤器保养信息<span id="yl_1"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Oilfilter' && $allMaintain_item['time_left'] <= 24 && $allMaintain_item['time_left'] > 0){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Oilfilter' && $allMaintain_item['time_left'] <= 24 && $allMaintain_item['time_left'] > 0):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_yl2">
	<div>
		<h4>油滤器保养信息<span id="yl_2"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Oilfilter' && $allMaintain_item['time_left'] <= 168 && $allMaintain_item['time_left'] > 24){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Oilfilter' && $allMaintain_item['time_left'] <= 168 && $allMaintain_item['time_left'] > 24):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_yl3">
	<div>
		<h4>油滤器保养信息<span id="yl_3"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Oilfilter' && $allMaintain_item['time_left'] <= 720 && $allMaintain_item['time_left'] > 168){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Oilfilter' && $allMaintain_item['time_left'] <= 720 && $allMaintain_item['time_left'] > 168):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_yl4">
	<div>
		<h4>油滤器保养信息<span id="yl_4"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Oilfilter' && $allMaintain_item['time_left'] <= 1440 && $allMaintain_item['time_left'] > 720){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Oilfilter' && $allMaintain_item['time_left'] <= 1440 && $allMaintain_item['time_left'] > 720):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_yl5">
	<div>
		<h4>油滤器保养信息<span id="yl_5"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Oilfilter' && $allMaintain_item['time_left'] > 1440){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table  table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Oilfilter' && $allMaintain_item['time_left'] > 1440):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_yf0">
	<div>
		<h4>油分器保养信息<span id="yf_0"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Oilsplitter' && $allMaintain_item['time_left'] <= 0){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table  table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Oilsplitter' && $allMaintain_item['time_left'] <= 0):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_yf1">
	<div>
		<h4>油分器保养信息<span id="yf_1"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Oilsplitter' && $allMaintain_item['time_left'] <= 24 && $allMaintain_item['time_left'] > 0){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table  table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Oilsplitter' && $allMaintain_item['time_left'] <= 24 && $allMaintain_item['time_left'] > 0):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_yf2">
	<div>
		<h4>油分器保养信息<span id="yf_2"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Oilsplitter' && $allMaintain_item['time_left'] <= 168 && $allMaintain_item['time_left'] > 24){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table  table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Oilsplitter' && $allMaintain_item['time_left'] <= 168 && $allMaintain_item['time_left'] > 24):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_yf3">
	<div>
		<h4>油分器保养信息<span id="yf_3"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Oilsplitter' && $allMaintain_item['time_left'] <= 720 && $allMaintain_item['time_left'] > 168){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table  table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Oilsplitter' && $allMaintain_item['time_left'] <= 720 && $allMaintain_item['time_left'] > 168):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_yf4">
	<div>
		<h4>油分器保养信息<span id="yf_4"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Oilsplitter' && $allMaintain_item['time_left'] <= 1440 && $allMaintain_item['time_left'] > 720){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table  table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Oilsplitter' && $allMaintain_item['time_left'] <= 1440 && $allMaintain_item['time_left'] > 720):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_yf5">
	<div>
		<h4>油分器保养信息<span id="yf_5"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Oilsplitter' && $allMaintain_item['time_left'] > 1440){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table  table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Oilsplitter' && $allMaintain_item['time_left'] > 1440):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_rz0">
	<div>
		<h4>润滑脂保养信息<span id="rz_0"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Lubricatingoil' && $allMaintain_item['time_left'] <= 0){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table  table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Lubricatingoil' && $allMaintain_item['time_left'] <= 0):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_rz1">
	<div>
		<h4>润滑脂保养信息<span id="rz_1"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Lubricatingoil' && $allMaintain_item['time_left'] <= 24 && $allMaintain_item['time_left'] > 0){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table  table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Lubricatingoil' && $allMaintain_item['time_left'] <= 24 && $allMaintain_item['time_left'] > 0):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_rz2">
	<div>
		<h4>润滑脂保养信息<span id="rz_2"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Lubricatingoil' && $allMaintain_item['time_left'] <= 168 && $allMaintain_item['time_left'] > 24){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table  table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Lubricatingoil' && $allMaintain_item['time_left'] <= 168 && $allMaintain_item['time_left'] > 24):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_rz3">
	<div>
		<h4>润滑脂保养信息<span id="rz_3"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Lubricatingoil' && $allMaintain_item['time_left'] <= 720 && $allMaintain_item['time_left'] > 168){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table  table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Lubricatingoil' && $allMaintain_item['time_left'] <= 720 && $allMaintain_item['time_left'] > 168):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_rz4">
	<div>
		<h4>润滑脂保养信息<span id="rz_4"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Lubricatingoil' && $allMaintain_item['time_left'] <= 1440 && $allMaintain_item['time_left'] > 720){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table  table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Lubricatingoil' && $allMaintain_item['time_left'] <= 1440 && $allMaintain_item['time_left'] > 720):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
...
<div style="color:#fff;background:rgba(0,0,0,0.85);height:300px;width:500px;display:none;position: absolute;z-index:1;padding:10px;" id="detail_rz5">
	<div>
		<h4>润滑脂保养信息<span id="rz_5"><?php 
			$num=0;
			foreach ($allMaintain as $allMaintain_item){
				if($allMaintain_item['item'] == 'Lubricatingoil' && $allMaintain_item['time_left'] > 1440){
					$num++;
				}
			}
			echo $num;
	...
	<div style="height:240px;overflow:auto">
		<table class="table  table-condensed table-bordered">
			...
			<tbody>
				<?php foreach ($allMaintain as $allMaintain_item):?>
				<?php if($allMaintain_item['item'] == 'Lubricatingoil' && $allMaintain_item['time_left'] > 1440):?>
				<tr>
					<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/admin/index/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['device_id']?></a></td>
					<td><?php echo $allMaintain_item['machine_type']?></td>
					<td><?php echo $allMaintain_item['machine_controller']?></td>
