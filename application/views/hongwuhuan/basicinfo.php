								...
								<div class="panel-body">
									<div class="row">
										...
										<div class="col-lg-5 col-md-6 col-sm-5 col-xs-5">
											<div><i class="fa fa-sort-amount-asc" style="padding:5px"></i>设备类型:<strong class="text-danger"><?php if(isset($device_info['machine_type'])){echo $device_info['machine_type'];}else{echo "";} ?></strong></div>
											<div><i class="fa fa-tag" style="padding:5px"></i>型号:<strong class="text-danger"><?php if(isset($device_info['machine_model'])){echo $device_info['machine_model'];}else{echo "";} ?></strong></div>
											<div><i class="fa fa-tachometer" style="padding:5px"></i>控制器型号:<strong class="text-danger"><?php if(isset($device_info['machine_controller'])){echo $device_info['machine_controller'];}else{echo "";} ?></strong></div>
											<div><i class="fa fa-clock-o" style="padding:5px"></i>录入时间:<strong class="text-danger"><?php if(isset($device_info['create_time'])){echo $device_info['create_time'];}else{echo "";} ?></strong></div>
                                            <div><i class="fa fa-map-marker" style="padding:5px"></i>经度:<strong class="text-danger" id="gps_long"><?php if(isset($device_info['GPS_long'])){ echo $device_info['GPS_long'];}else{echo "";} ?></strong></div>
                                            <div><i class="fa fa-map-marker" style="padding:5px"></i>纬度:<strong class="text-danger" id="gps_lat"><?php if(isset($device_info['GPS_lat'])){echo $device_info['GPS_lat'];}else{echo "";} ?></strong></div>
										</div>
									</div>	
								</div>	
								<!--/div-->
						...
						<div class="panel-body">
							<ul class="chat">							
								...
								<?php $flag=0; foreach($allDevice as $device): ?>
                                    <li class="right clearfix setList">
                        ...
                        <div class="panel-footer">
							<div class="row">
								<div class="col-lg-6 col-md-12 col-sm-6 col-xs-6">
									<button type="submit" class="btn btn-primary text-center" id="prevPage">上一页</button> 
									<button type="submit" class="btn btn-primary text-center" id="nextPage">下一页</button>
								</div>
								<div class="col-lg-6 col-md-12 col-sm-6 col-xs-6">
