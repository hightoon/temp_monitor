									...
									<table style="width:100%" class="table table-bordered table-condensed" id="dataTables-alarm">
										...
										<tbody>
											...
											<?php foreach ($allWarning as $allWarning_list):?>
												<tr>
													<td><a href="<?php $tmp = base_url(); echo $tmp.'index.php/'.$admin_dir.'/'.$allWarning_list['href']?>"><?php echo $allWarning_list['cv_id']?></a></td>
									...
									<table class="table table-bordered table-condensed" id="dataTables-maintain">
										...
										<tbody>
											...
											<?php foreach ($allMaintain as $maintain):?>
												<tr>
													<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/'.$maintain['href']?>"><?php echo $maintain['cv_id']?></a></td>
													<td><?php echo $maintain['name']?></td>
													<td><?php echo $maintain['period1']?>小时</td>
													<td
													<?php
														if($maintain['left_time'] < 24){
															echo "style=\"background-color:#f00;color:#FFF\"";
														}
													?>
													><?php echo $maintain['left_time']?>小时</td>
													<td>
														<?php
															$item = ($maintain['last_maintain_date'])?($maintain['last_maintain_date']):("暂未保养过");
															echo $item;
														?>
													</td>
													<td>
