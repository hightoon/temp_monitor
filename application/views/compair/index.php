										...
										<div class="table-responsive" style="overflow:auto;height:300px">
											<table class="table table-condensed table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/'.$allAlarm_item['href'] ?>"><?php echo $allAlarm_item['cv_id'] ?></a></td>
											...
											<table class="table table-condensed table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<?php if (1 == $allEqp_item['isOnline']):?>
														<tr>
															<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/'.$allEqp_item['href']?>"><?php echo $allEqp_item['cv_id'] ?></a></td>
											...
											<table class="table table-condensed table-striped table-bordered table-hover">
												...
												<tbody>
													<?php foreach ($allMaintain as $allMaintain_item): ?>
														<tr>
															<td><a href="<?php $tmp=base_url(); echo $tmp.'index.php/'.$admin_dir.'/'.$allMaintain_item['href']?>"><?php echo $allMaintain_item['cv_id'] ?></a></td>
