...
class Ajax_setslist extends CI_Controller{
	...
	public function setslist(){
		$data= $this->yuehua_model->get_news();
	...
	public function delDevice(){
		...
		$this->yuehua_model->delDevice($device_id);
	...
	public function editDevice(){
		...
		$ret = $this->yuehua_model->setDeviceInfo($info);
		echo $ret;
		return;
	}
	...
	public function allEqp(){
		$data= $this->yuehua_model->get_allEqp();
	...
	public function saveMaintainRemark(){
		...
		$ret = $this->yuehua_model->setMaintainRemark($info);
		echo $ret;
		return;
	}
}
