...
class Admin extends CI_Controller{
    ...
    public function index(){
        ...
        if (NULL != $url_encrypt){
            ...
            switch ($segment[0]){
                case "setslist":/*所有设备信息*/
                    $this->setslist();
                    return;
                    break;
                case "basicinfo":/*单台设备概况*/
                    $this->basicinfo($segment[1]);
                    return;
                    break;
                case "realtimeinfo":/*实时监控*/
                    $this->realtimeinfo($segment[1]);
                    return;
                    break;
                case "historyinfo":/*历史信息*/
                ...
                case "userset":/*账户管理*/
                    ...
                    return;
                    break;
                case "upload_file":/*账户管理中上传图片*/
                    $this->upload_file();
                    return;
                    break;
                case "change_logo":/*账户管理中更改logo*/
                    $this->change_logo();
                    return;
                    break;
                case "passwdchange":/*账户管理中更改密码*/
                    $this->passwdchange();
                    return;
                    break;
                case "add_user":/*账户管理中添加用户*/
                    $this->add_user();
                    return;
                    break;
                case "del_user":/*账户管理中删除用户*/
                    $this->del_user();
                    return;
                    break;
                case "edit_user":/*账户管理中编辑用户*/
                    $this->edit_user();
                    return;
                    break;
                default:
