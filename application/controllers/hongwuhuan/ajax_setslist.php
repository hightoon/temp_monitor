...
class Ajax_setslist extends CI_Controller{
	...
	public function __construct(){
		parent::__construct();
		$this->load->model('hongwuhuan_model');
		$this->load->helper('url');
	}

	public function setslist(){
		$data= $this->hongwuhuan_model->get_news();
	...
	public function delDevice(){
		...
		$this->hongwuhuan_model->delDevice($device_id);
	...
	public function editDevice(){
		...
		$ret = $this->hongwuhuan_model->setDeviceInfo($info);
		echo $ret;
		return;
	}
	...
	public function allEqp(){
		$data= $this->hongwuhuan_model->get_allEqp();
	...
	public function saveMaintainRemark(){
		...
		$ret = $this->hongwuhuan_model->setMaintainRemark($info);
		echo $ret;
		return;
	}
}
