...
class Ajax_setslist extends CI_Controller{
	...
	public function __construct(){
		parent::__construct();
		$this->load->model('ceshitest_model');
		$this->load->helper('url');
	}

	public function setslist(){
		$data= $this->ceshitest_model->get_news();
	...
	public function delDevice(){
		...
		$this->ceshitest_model->delDevice($device_id);
	...
	public function editDevice(){
		...
		$ret = $this->ceshitest_model->setDeviceInfo($info);
		echo $ret;
		return;
	}
	...
	public function allEqp(){
		$data= $this->ceshitest_model->get_allEqp();
	...
	public function saveMaintainRemark(){
		...
		$ret = $this->ceshitest_model->setMaintainRemark($info);
		echo $ret;
		return;
	}
}
