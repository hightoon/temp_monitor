...
class Ajax_setslist extends CI_Controller{
	...
	public function editEqp(){
		...
		$data = array(
			...
			'cv_controller' => $_POST['cv_controller'],
			'cv_dealer'		=> $_POST['cv_dealer'],
	...
	public function allEqp(){
		$data= $this->info_model->get_allEqp();
	...
	public function saveMaintainRemark(){
		...
		$ret = $this->info_model->set_robomaintainremark($_POST['cv_id'],$type,$_POST['remark']);
		echo $ret;
		return;
	}
}
