...
class Ajax_setslist extends CI_Controller{
	...
	public function setslist(){
		$data= $this->bolaite_model->get_news();
	...
	public function delDevice(){
		...
		$this->bolaite_model->delDevice($device_id);
	...
	public function editDevice(){
		...
		$ret = $this->bolaite_model->setDeviceInfo($info);
		echo $ret;
		return;
	}
	...
	public function allEqp(){
		$data= $this->bolaite_model->get_allEqp();
	...
	public function saveMaintainRemark(){
		...
		$ret = $this->bolaite_model->setMaintainRemark($info);
		echo $ret;
		return;
	}
}
