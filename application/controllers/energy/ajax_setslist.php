...
class Ajax_setslist extends CI_Controller{
	...
	public function setslist(){
		$data= $this->energy_model->get_news();
	...
	public function delDevice(){
		...
		$this->energy_model->delDevice($device_id);
	...
	public function editDevice(){
		...
		$ret = $this->energy_model->setDeviceInfo($info);
		echo $ret;
		return;
	}
	...
	public function allEqp(){
		$data= $this->energy_model->get_allEqp();
	...
	public function saveMaintainRemark(){
		...
		$ret = $this->energy_model->setMaintainRemark($info);
		echo $ret;
		return;
	}
}
