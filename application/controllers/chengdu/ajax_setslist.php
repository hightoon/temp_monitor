...
class Ajax_setslist extends CI_Controller{
	...
	public function setslist(){
		$data= $this->chengdu_model->get_news();
	...
	public function delDevice(){
		...
		$this->chengdu_model->delDevice($device_id);
	...
	public function editDevice(){
		...
		$ret = $this->chengdu_model->setDeviceInfo($info);
		echo $ret;
		return;
	}
	...
	public function allEqp(){
		$data= $this->chengdu_model->get_allEqp();
	...
	public function saveMaintainRemark(){
		...
		$ret = $this->chengdu_model->setMaintainRemark($info);
		echo $ret;
		return;
	}
}
