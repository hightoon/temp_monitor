...
class Admin extends CI_Controller{
    ...
    public function index(){
        ...
        $this->data['allDevice']= $this->chengdu_model->getAllDevice();
        ...
        $allOnlineDevice = $this->chengdu_model->getAllOnlineDevice();/**/
        $this->data['onlineDeviceNum'] = 0;
        for($i=0; $i<$allOnlineDevice[0]; $i++){
			if($allOnlineDevice[$i+2] > 15000 && $allOnlineDevice[$i+2] < 20000){
        ...
        $this->data['allAlarm'] = array();//$this->chengdu_model->getAllAlarm();/**/
        $this->data['alarmNum'] = count($this->data['allAlarm']);
        
        $this->data['allRemark'] = $this->chengdu_model->getAllRemark();/**/
        $this->data['remarkNum'] = count($this->data['allRemark']);
        
        $this->data['allMaintain'] = $this->chengdu_model->getAllMaintain();/**/
    ...
    public function setslist(){
        ...
        foreach($this->data['allDevice'] as $device){
            ...
            $this->data['allWarning']= $this->chengdu_model->getAllAlarm($device['device_id']);
            //$this->data['allMaintain']= $this->chengdu_model->getAllMaintain();  
        }
    ...
    public function basicinfo($device_id=FALSE){
        ...
        if($device_id!=FALSE){
            ...
            $this->data['maintain'] = $this->chengdu_model->getAllMaintain($device_id);
            
            $this->data['device_info'] = $this->chengdu_model->getAllDevice($device_id);
    ...
    public function realtimeinfo($device_id = FALSE){
        ...
        if($this->session->userdata('admin_level') == 99){
            ...
            if($device_id != FALSE){
                $this->data['meters'] = $this->user_chengdu_model->get_robometers($device_id);
                $this->data['device_id'] = $device_id;
            }
        ...
        if ($device_id != FALSE){
			...
			$deviceInfo = $this->chengdu_model->getAllDevice($device_id);

            $this->data['deviceSet'] = $this->chengdu_model->getDeviceSet($deviceInfo['device_type'],$deviceInfo['user_id']);
			
            $isOnline = $this->chengdu_model->getDeviceOnlineStatus($device_id - 8600000);
            ...
            if(0 ==  $isOnline){
                ...
                $this->data['device_id'] = $device_id;
                /*$onlineEqp = $this->chengdu_model->get_allEqp_online();*/
    ...
    public function historyinfo($device_id = FALSE){
        ...
        if ($device_id != FALSE){
            ...
            $this->data['deviceSet'] = $this->chengdu_model->getDeviceSet($deviceInfo['device_type'],$deviceInfo['user_id']);
			$num = 100;
			$this->data['allHistoryInfo'] = $this->chengdu_model->getAllHistoryInfo($device_id,$num);
            $this->data['device_id'] = $device_id;
        }
    ...
    public function infoset(){
		...
		$this->data['deviceSet'] = $this->chengdu_model->getDeviceSet();
    ...
    public function passwdchange(){
		...
		if (FALSE == $this->chengdu_model->changePasswd($name,$newPasswd)){
            echo 0;
            return;
		}else{
            echo 1;
    ...
    public function add_user(){
        ...
        $this->user_chengdu_model->add_user($info);
        echo 0;
        return;
    }
    ...
    public function edit_user(){
        ...
        $this->user_chengdu_model->edit_user($info,$_POST['edituser_name']);
        echo 0;
        return;
    }
    ...
    public function del_user(){
        ...
        $this->user_chengdu_model->del_user($name);
        echo 0;
        return;
    }
}
