...
var base_url="http://www.robosnet.com/civ";
$(function(){
...
function  userset0_submit(){
	...
	$.ajax({
		type:"POST",
		url:base_url+'index.php/'+admin_dir+'/'+$("#passwd_ch_button").val(),
...
$('#logo_update').click(function(e) {
	...
	e.preventDefault();
	$.ajaxFileUpload({
		url         :base_url+'index.php/'+admin_dir+'/'+$("#logo_update").val(),
		secureuri      :false,
...
$("#logo_change").click(function(e){
	$.ajax({
		type:"POST",
		url:base_url+'index.php/'+admin_dir+'/'+$("#logo_change").val(),
		success:function(msg){
			if(msg==0){
				/*$("#myModal_type").attr({style:"color:#fff;background:#3c2"});
				$("#myModal_Label").html("成功");
...
$("#newuser_add").click(function(e){
	...
	$.ajax({
		type:"POST",
		url:base_url+'index.php/'+admin_dir+'/'+$("#newuser_add").val(),
		dataType    : 'json',
		data        : {
...
$("#edituser_confirm").click(function(e){
	...
	$.ajax({
		type:"POST",
		url:base_url+'index.php/'+admin_dir+'/'+$("#edituser_confirm").val(),
		dataType    : 'json',
		data        : {
...
function del_user(){
	...
	$.ajax({
		type:"POST",
		url:base_url+'index.php/'+admin_dir+'/'+$("#del_option").attr("value"),
		dataType    : 'json',
		data        : {
