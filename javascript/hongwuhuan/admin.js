    ...
    $.ajax({
        ...
        success :function(msg){
            ...
            for (var index in msg){
                if(msg[index]['GPS_long']!=null && msg[index]['GPS_lat']!= null){
                    gpsPoint[i]=new BMap.Point(msg[index]['GPS_long'],msg[index]['GPS_lat']);
                    i++;
                }
            }
...
$(function() {
	...
	function loadJScript() {
		...
		script2.src = "http://api.map.baidu.com/library/TextIconOverlay/1.2/src/TextIconOverlay_min.js";
		
		var script3 = document.createElement("script");
		script3.type = "text/javascript";
		script3.src = "http://api.map.baidu.com/library/MarkerClusterer/1.2/src/MarkerClusterer_min.js";
		...
		document.body.appendChild(script3);*/
        	...
        	/*var map = new BMap.Map("allEqp_map");
    ...
    var options = {
        ...
        yaxis: {
            tickFormatter: function suffixFormatter(val, axis) {return val+"台/次";},
            tickDecimals:0
        },
        grid: {
            hoverable: true,
